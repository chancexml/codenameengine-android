...
class Controls extends FlxActionSet
{
	...
	inline function get_ACCEPT():Bool {
        return getPressed("accept");
	}
	inline function get_ACCEPT_P():Bool {
        return getJustPressed("accept");
	}
	inline function get_ACCEPT_R():Bool {
        return getJustReleased("accept");
	}
	inline function get_BACK():Bool {
        return getPressed("back");
	}
	inline function get_BACK_P():Bool {
        return getJustPressed("back");
	}
	inline function get_BACK_R():Bool {
        return getJustReleased("back");
	}
	inline function get_SWITCHMOD_HOLD():Bool {
        return getPressed("switchmod");
	}
	inline function get_SWITCHMOD():Bool {
        return getJustPressed("switchmod");
	}
	inline function get_SWITCHMOD_R():Bool {
        return getJustReleased("switchmod");
	}
	inline function get_DEV_ACCESS_HOLD():Bool {
        return getPressed("dev-access");
	}
	inline function get_DEV_ACCESS():Bool {
        return getJustPressed("dev-access");
	}
	inline function get_DEV_ACCESS_R():Bool {
        return getReleased("dev-access");
	}
	inline function get_PAUSE_HOLD():Bool {
        return getPressed("pause");
	}
	inline function get_PAUSE():Bool {
        return getJustPressed("pause");
	}
	inline function get_PAUSE_R():Bool {
        return getJustReleased("pause");
	}
	inline function get_CHANGE_MODE_HOLD():Bool {
        return getPressed("change-mode");
	}
	inline function get_CHANGE_MODE():Bool {
        return getJustPressed("change-mode");
	}
	inline function get_CHANGE_MODE_R():Bool {
        return getJustReleased("change-mode");
	}
	inline function get_FPS_COUNTER_HOLD():Bool {
        return getPressed("fps-counter");
	}
	inline function get_FPS_COUNTER():Bool {
        return getJustPressed("fps-counter");
	}
	inline function get_FPS_COUNTER_R():Bool {
        return getJustReleased("fps-counter");
	}
	inline function get_UP():Bool {
        return getPressed("up");
	}
	inline function get_UP_P():Bool {
        return getJustPressed("up");
	}
	inline function get_UP_R():Bool {
        return getJustReleased("up");
	}
	inline function get_DOWN():Bool {
        return getPressed("down");
	}
	inline function get_DOWN_P():Bool {
        return getJustPressed("down");
	}
	inline function get_DOWN_R():Bool {
        return getJustReleased("down");
	}
	inline function get_LEFT():Bool {
        return getPressed("left");
	}
	inline function get_LEFT_P():Bool {
        return getJustPressed("left");
	}
	inline function get_LEFT_R():Bool {
        return getJustReleased("left");
	}
	inline function get_RIGHT():Bool {
        return getPressed("right");
	}
	inline function get_RIGHT_P():Bool {
        return getJustPressed("right");
	}
	inline function get_RIGHT_R():Bool {
        return getJustReleased("right");
	}
	#end
